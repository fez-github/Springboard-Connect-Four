...
function beginGame(evt){
  evt.target.parentElement.parentElement.style.visibility = 'hidden';
  let newGame = new Connect4Game(parseInt(inputWidth.value),parseInt(inputHeight.value),parseInt(inputTimer.value),document.getElementById('game'));
